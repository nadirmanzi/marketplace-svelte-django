...
export async function publishProduct(productId: string, customFetch: typeof fetch = fetch) {
	return apiFetch<ProductDetailResponse>(
		`/catalog/products/manage/${productId}/publish/`,
		{
			method: 'POST'
		},
		customFetch
...
export async function archiveProduct(productId: string, customFetch: typeof fetch = fetch) {
	return apiFetch<ProductDetailResponse>(
		`/catalog/products/manage/${productId}/archive/`,
		{
			method: 'POST'
		},
		customFetch
...
export async function adjustStock(
	...
	return apiFetch<VariantDetailResponse>(
		`/catalog/variants/manage/${variantId}/adjust-stock/`,
		{
			method: 'POST',
